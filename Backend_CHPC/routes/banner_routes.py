...
@rol_requerido('administrador')  # Solo administradores pueden crear banners
def crear_banner():
...
@rol_requerido('administrador')  # Solo administradores pueden actualizar banners
...
@rol_requerido('administrador')  # Solo administradores pueden eliminar banners
